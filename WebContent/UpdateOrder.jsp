              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="active">
                      <a href="contact.html">update Order </a>
                    </li>
                  </ul>
                </nav>
              </div>
...
<div class="containerr">
  <form action ="UpdateOrder" method ="post">
      ...
      <h4>Order ID</h4>
        ...
        <input type="textArea" name ="details" value="<%= Order_ID %>"  readonly />
    ...
    <div class="roww">
      <h4>Customer Type</h4>
    <div class="input-groupp">
        <input type="radio" name="CustomerType" value="<%=CustomerType %>" id="prepaid" checked="true"/>
        <label for="prepaid"><span><i class="fa fa-cc-visa"></i>Prepaid Customer</span></label>
        <input type="radio" name="CustomerType" value="<%=CustomerType%>" id="postpaid"/>
      ...
      <div class="col-halff">
        ...
        <div class="input-groupp">
          <div class="col-thirdd">
            <input type="text" name ="Date" value="<%=Date %>" placeholder="DD"/>
          </div>
          <div class="col-thirdd">
            <input type="text" name ="Date" value="<%=Date%>" placeholder="MM"/>
          </div>
          <div class="col-thirdd">
            <input type="text" name ="Date" value="<%=Date%>" placeholder="YYYY"/>
          </div>
        </div>
      </div>
	  </div>
    ...
    <div class="input-groupp">
        <input type="radio" name="OrderMethod" value="<%=OrderMethod%>" id="home" checked="true"/>
        <label for="home"><span><i class="fa fa-cc-visa"></i>Collect From Home</span></label>
        <input type="radio" name="OrderMethod" value="<%=OrderMethod%>" id="shop"/>
      ...
      <h4>Location</h4>
	     <div class="input-groupp">
        <input type="textbox" name ="Location" value="<%=Location%>" placeholder="Address"/>
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
      ...
      <h4>Additional Details</h4>
	     <div class="input-groupp ">
        <input type="textArea" name ="details" value="details" placeholder="More details"/>
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
      ...
      <h4>Payment Amount</h4>
	     <div class="input-groupp ">
        <input type="textArea" name ="PaymentAmount" value="<%=PaymentAmount%>" />
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
    ...
    <div class="roww">
      ...
      <div class="input-groupp">
        <input type="radio" name="payment-method" value="paymentmethod" id="payment-method-card" checked="true"/>
        <label for="payment-method-card"><span><i class="fa fa-cc-visa"></i>Credit Card</span></label>
        <input type="radio" name="payment-method" value="paymentmethod" id="payment-method-paypal"/>
        <label for="payment-method-paypal"> <span><i class="fa fa-cc-paypal"></i>Paypal</span></label>
      </div>
      <div class="input-groupp ">
        <input type="text" value="number" name ="number" placeholder="Card Number"/>
        <div class="input-iconn"><i class="fa fa-credit-card"></i></div>
      </div>
      <div class="col-half">
        <div class="input-groupp ">
          <input type="text" value="<cvc" name ="cvc" placeholder="Card CVC"/>
          <div class="input-iconn"><i class="fa fa-user"></i></div>
        </div>
      </div>
      <div class="col-half">
