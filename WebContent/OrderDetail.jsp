...
<body>
  ...
  <div id="wrapper">
              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="active">
                      <a href="contact.html">Order Details </a>
                    </li>
                  </ul>
                </nav>
              </div>
    ...
    <section id="content">
		...
		<c:set var= "Order_ID" value="${ord.Order_ID}"/>
		<c:set var= "CustomerType" value="${ord.CustomerType}"/>
		<c:set var= "Date" value="${ord.Date}"/>
		<c:set var= "OrderMethod" value="${ord.OrderMethod}"/>
		<c:set var= "Location" value="${ord.Location}"/>
		<c:set var= "PaymentAmount" value="${ord.PaymentAmount}"/>
		...
		<c:url value="UpdateOrder.jsp" var="ordupdate">
			...
			<c:param name="OrderMethod" value="${OrderMethod}"/>
		...
		<a href="${ordupdate}">
		<input type="button" name="update" class="login1" id="btnl"  value="update order">
		</a>
		
		<br>
		<a href ="${orddelete}">
		<c:url value= "DeleteOrder.jsp" value="orddelete">
			<c:param name="Order_ID" value="${Order_ID}"/>
			<c:param name="CustomerType" value="${CustomerType}"/>
			<c:param name="Date" value="${Date}"/>
			<c:param name="OrderMethod" value="${OrderMethod}"/>
		...
		<input type= "button" name="delete" class="login1" id="btnl"  value ="delete order">
		</a>
