            ...
            <div class="row">
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  ...
                  <div class="action">
                    <a href="createPackages.html" class="btn btn-inverse">Create</a>
                  </div>
                </div>
              </div>
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  ...
                  <div class="action">
                    <a href="#" class="btn btn-inverse">Edit</a>
                  </div>
                </div>
              </div>
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  <div class="heading">
                    <h4>Delete Packages</h4>
                    
                  </div>
                  
                  <div class="action">
                    <a href="#" class="btn btn-color">Delete</a>
                  </div>
                </div>
              </div>
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  ...
                  <form action = "displayUnregDetails" method = "post">
                  <div class="action">
                    <button class="btn btn-color" type = "submit">View</button>
                  </div>
                  </form>
                </div>
              </div>
