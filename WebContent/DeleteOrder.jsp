              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="active">
                      <a href="contact.html">Cancel Order </a>
                    </li>
                  </ul>
                </nav>
              </div>
...
<div class="containerr">
  <form action ="DeleteOrder" method ="post">
      ...
      <h4>Order ID</h4>
        ...
        <input type="textbox" name ="Order_ID" value="<%=Order_ID%>" readonly/>
      ...
      <h4>Date</h4>
	     <div class="input-groupp">
        <input type="textbox" name ="Date" value="<%=Date%>" readonly/>
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
     ...
     <div class="roww">
      <h4>Payment Amount</h4>
	     <div class="input-groupp">
        <input type="textbox" name ="PaymentAmount" value="<%=PaymentAmount%>" readonly/>
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
      ...
      <h4>inquaries</h4>
	     <div class="input-groupp ">
        <input type="textArea" name ="inquaries" value="inquaries"  placeholder=" details"/>
        <div class="input-iconn"><i class="fa fa-user"></i></div>
      </div>
    </div>
    ...
    <div class="roww">
      ...
      <div class="input-groupp">
        ...
        <label for="terms">I am aware about terms and conditions for canceling the order, and hereby confirm I have read the privacy policy.</label>
      </div>
	<input  type="submit" class="login1" id="btnl" name="btnl" value="confirm delete" >
    </div>
  </form>
</div>
